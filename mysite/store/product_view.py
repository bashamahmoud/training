...
class ProductView(viewsets.ViewSet):
    ...
    # GET request: http://127.0.0.1:8000/store/products  #get all products
    ...
    # GET request: http://127.0.0.1:8000/store/products/{pk}  #get product of given id
    ...
    # POST request: http://127.0.0.1:8000/store/products #create new product
    ...
    # DELETE request: http://127.0.0.1:8000/store/products/{pk} #delete product of given id
    ...
    # PUT request: http://127.0.0.1:8000/store/products/{pk} #update product of given id
